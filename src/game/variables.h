...
MACRO_CONFIG_INT(SvWallLimmit, sv_wall_limmit, 0, 0, 0, CFGFLAG_SERVER, "Wall limmit")
MACRO_CONFIG_INT(SvWallLength, sv_wall_length, 0, 0, 0, CFGFLAG_SERVER, "Wall length")
MACRO_CONFIG_STR(SvPermBroadcast, sv_perm_broadcast, 900, "", CFGFLAG_SERVER, "Permanent Broatcast")
// debug
