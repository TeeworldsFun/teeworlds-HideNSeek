...
int IGameController::OnCharacterDeath(class CCharacter *pVictim, class CPlayer *pKiller, int Weapon)
{
	...
	pVictim->GetPlayer()->m_AnimalChangeable = false;		
	return 0;
}
...
void IGameController::OnCharacterSpawn(class CCharacter *pChr)
{
	...
	pChr->GetPlayer()->m_AnimalChangeable = true;
}
...
{
	GameServer()->SendBroadcast(g_Config.m_SvPermBroadcast, -1);
	// do warmup
	if(m_Warmup)
	{
		m_Warmup--;
